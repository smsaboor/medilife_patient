...
class DoctorCardHorizontalPD extends StatelessWidget {
  const DoctorCardHorizontalPD({ Key? key, required this.index, required this.doctor, required this.onTap}) : super(key: key);
  final int index;
  final doctor;
